 ...
 */
export function derivationMessage(address, scope) {
    return [
 ...
 */
export function deriveAccountKey(signature) {
 ...
 */
export function verifyAndDerive(address, scope, signature, signatureRepeat) {
    ...
    if (signature.toLowerCase() !== signatureRepeat.toLowerCase()) {
        throw new Error('This wallet does not produce stable signatures: signing the same message ' +
